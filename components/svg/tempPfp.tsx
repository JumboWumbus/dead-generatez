...
export const TempPfp = ({ className, fill }: Props) => {
    return (
        <svg
            id="a"
            className={className ? className : ""}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 127.41 127.41"
        >
            <rect
                className="b"
