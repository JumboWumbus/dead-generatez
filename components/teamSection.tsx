...
export default function TeamSection() {
  return (
    ...
    <div className={styles.memberContainer}>
        <img className={styles.memberImage} src="./images/place.jpeg"/>
        <div className={styles.memberInfoContainer}>
            ...
            <p className={styles.memberParagraph}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, id perspiciatis ducimus itaque tenetur laborum quaerat. Debitis impedit blanditiis rerum magnam repudiandae sunt, voluptatem corporis exercitationem necessitatibus maxime qui accusantium, iure veniam sint natus autem!</p>
