  ...
  return (
    <nav className={styles.navBar}>
      <div className={styles.navContainer}>
        <Link href="/" passHref>
          <Logo skull="#ffffff" eyes="#000000" width={"75px"} className={styles.navLogo} />
        </Link>

<input id="page-nav-toggle" className={styles.mainNavigationToggle} type="checkbox" />
